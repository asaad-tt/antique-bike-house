      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            This is our professional team who can sort out any problem and keep
            the product quality up to the mark.
          </p>
        </div>
        <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm text-gray-800">Service Team Lead</p>
            </div>
          </div>
          <div className="flex">
            <img
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm text-gray-800">Service engineer</p>
            </div>
          </div>
          <div className="flex">
            <img
